;; Adapted from https://github.com/babashka/babashka/blob/238a98d9b205cd59d6af60211729cb88f39b6e2d/src/babashka/impl/classes.clj

(ns simple.reflection
  {:no-doc true}
  (:require
   #_[babashka.impl.features :as features]
   #_[babashka.impl.proxy :as proxy]
   [clj-jgit.porcelain :as clj-jgit]
   [cheshire.core :as json]
   #_[sci.core :as sci]
   #_[sci.impl.types :as t]))
...
(def base-custom-map
  `{clojure.lang.LineNumberingPushbackReader {:allPublicConstructors true
    ...
    {:methods [{:name "aget"}
               ...
               {:name "baseLoader"}]}
    #_clojure.lang.Compiler
    #_{:fields [{:name "specials"}
              {:name "CHAR_MAP"}]}
...
(def custom-map
  (cond->
   (merge base-custom-map
          #_proxy/custom-reflect-map)
    false #_features/hsqldb? (assoc `org.hsqldb.dbinfo.DatabaseInformationFull
                            {:methods [{:name "<init>"
...
(def classes
  `{:all [org.eclipse.jgit.internal.JGitText
    ;] #_[
          ...
          ~@(when false #_features/datascript?
          ...
          #_org.jsoup.Jsoup
          #_org.jsoup.nodes.Attribute
          #_org.jsoup.nodes.Attributes
          #_org.jsoup.nodes.Comment
          #_org.jsoup.nodes.DataNode
          #_org.jsoup.nodes.Document
          #_org.jsoup.nodes.DocumentType
          #_org.jsoup.nodes.Element
          #_org.jsoup.nodes.Node
          #_org.jsoup.nodes.TextNode
          #_org.jsoup.nodes.XmlDeclaration
          #_org.jsoup.parser.Tag
          #_org.jsoup.parser.Parser]
    ...
    :fields [clojure.lang.PersistentQueue
             #_~@(when features/postgresql? '[org.postgresql.PGProperty])]
    ...
    :instance-checks [clojure.lang.AFn
                      ...
                      #_~@(when features/xml? ['clojure.data.xml.node.Element])]
    :custom ~custom-map})
        ...
        m (assoc m :public-class
                 (fn [v]
                   ...
                   (let [res (cond (instance? java.lang.Process v)
                                   ...
                                   #_(instance? sci.impl.types.IReified v)
                                   #_(first (t/getInterfaces v))
                                   ;; fix for #1061
                                   ...
                                   java.lang.Throwable
                                   #_(instance? org.jsoup.nodes.Element v)
                                   #_org.jsoup.nodes.Element
                                   (and thread-builder
...
(def class-map
  ...
  (delay (persistent! (reduce (fn [acc c]
                              ...
                              (transient class-map*) (when true #_features/java-net-http?
...
(defn reflection-file-entries []
  (let [entries (vec (for [c (sort (concat (:all classes)
                                           (when true #_features/java-net-http?
                                             java-net-http-classes)))
...
#_(def cns (sci/create-ns 'babashka.classes nil))

#_(def classes-namespace
  {:obj cns
